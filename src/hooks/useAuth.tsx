...
function AuthProvider({ children }: AuthProviderData) {
  ...
  async function signIn() {
    try {
      ...
      const response = await startAsync({ authUrl }) as AuthotizationResponse
  ...
  async function signOut() {
    try {
      ...
      await revokeAsync({ token: userToken, clientSecret: CLIENT_ID }, { revocationEndpoint: twitchEndpoints.revocation })
